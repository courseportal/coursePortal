...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'web_userrating')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'web_userrating', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratingUser', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'web', ['UserRating'])
