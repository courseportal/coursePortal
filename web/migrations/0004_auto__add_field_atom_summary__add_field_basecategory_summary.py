...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Atom.summary'
        db.add_column(u'web_atom', 'summary',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Adding field 'BaseCategory.summary'
        db.add_column(u'web_basecategory', 'summary',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Atom.summary'
        db.delete_column(u'web_atom', 'summary')

        # Deleting field 'BaseCategory.summary'
        db.delete_column(u'web_basecategory', 'summary')
