...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_bugreport', (
        ...
        db.send_create_signal(u'web', ['BugReport'])
        ...
        db.create_table(u'web_example', (
            ...
            ('atom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='example_set', to=orm['web.Atom'])),
        ...
        # Deleting field 'LectureNote.classBelong'
        db.delete_column(u'web_lecturenote', 'classBelong_id')

        # Adding field 'LectureNote.atom'
        db.add_column(u'web_lecturenote', 'atom',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='lecturenote_set', to=orm['web.Atom']),
                      keep_default=False)

        # Adding field 'LectureNote.date_created'
        db.add_column(u'web_lecturenote', 'date_created',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'web_bugreport')
        ...
        # Adding field 'LectureNote.classBelong'
        db.add_column(u'web_lecturenote', 'classBelong',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='classBelong', to=orm['web.Class']),
                      keep_default=False)

        # Deleting field 'LectureNote.atom'
        db.delete_column(u'web_lecturenote', 'atom_id')

        # Deleting field 'LectureNote.date_created'
        db.delete_column(u'web_lecturenote', 'date_created')
