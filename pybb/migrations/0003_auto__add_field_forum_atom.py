...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.atom'
        db.add_column(u'pybb_forum', 'atom',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forum', unique=True, null=True, to=orm['web.Atom']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.atom'
        db.delete_column(u'pybb_forum', 'atom_id')
