...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rating_vote', (
            ...
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Note'], null=True, blank=True)),
            ('exposition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Exposition'], null=True, blank=True)),
            ('example', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Example'], null=True, blank=True)),
    ...
    models = {
        ...
        u'rating.vote': {
            ...
            'example': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Example']", 'null': 'True', 'blank': 'True'}),
            'exposition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Exposition']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Note']", 'null': 'True', 'blank': 'True'}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pybb.Topic']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
