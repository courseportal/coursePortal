...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ATemplate'
        db.delete_table(u'assignment_atemplate')

        # Removing M2M table for field owners on 'ATemplate'
        db.delete_table(db.shorten_name(u'assignment_atemplate_owners'))

        # Removing M2M table for field questions on 'ATemplate'
        db.delete_table(db.shorten_name(u'assignment_atemplate_questions'))

        # Deleting model 'Template'
        db.delete_table(u'assignment_template')

        # Removing M2M table for field owners on 'Template'
        db.delete_table(db.shorten_name(u'assignment_template_owners'))

        # Deleting field 'Question.private'
        db.delete_column(u'assignment_question', 'private')

        # Deleting field 'Assignment.private'
        db.delete_column(u'assignment_assignment', 'private')


    def backwards(self, orm):
        # Adding model 'ATemplate'
        db.create_table(u'assignment_atemplate', (
        ...
        db.send_create_signal(u'assignment', ['ATemplate'])

        # Adding M2M table for field owners on 'ATemplate'
        m2m_table_name = db.shorten_name(u'assignment_atemplate_owners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('atemplate', models.ForeignKey(orm[u'assignment.atemplate'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['atemplate_id', 'user_id'])

        # Adding M2M table for field questions on 'ATemplate'
        m2m_table_name = db.shorten_name(u'assignment_atemplate_questions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('atemplate', models.ForeignKey(orm[u'assignment.atemplate'], null=False)),
            ('template', models.ForeignKey(orm[u'assignment.template'], null=False))
        ))
        db.create_unique(m2m_table_name, ['atemplate_id', 'template_id'])

        # Adding model 'Template'
        db.create_table(u'assignment_template', (
            ('data', self.gf('django.db.models.fields.TextField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'assignment', ['Template'])

        # Adding M2M table for field owners on 'Template'
        m2m_table_name = db.shorten_name(u'assignment_template_owners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('template', models.ForeignKey(orm[u'assignment.template'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['template_id', 'user_id'])

        # Adding field 'Question.private'
        db.add_column(u'assignment_question', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Assignment.private'
        db.add_column(u'assignment_assignment', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
