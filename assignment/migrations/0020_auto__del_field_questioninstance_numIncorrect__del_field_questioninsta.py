...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionInstance.numIncorrect'
        db.delete_column(u'assignment_questioninstance', 'numIncorrect')

        # Deleting field 'QuestionInstance.numCorrect'
        db.delete_column(u'assignment_questioninstance', 'numCorrect')

        # Adding field 'Question.numCorrect'
        db.add_column(u'assignment_question', 'numCorrect',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.numIncorrect'
        db.add_column(u'assignment_question', 'numIncorrect',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QuestionInstance.numIncorrect'
        db.add_column(u'assignment_questioninstance', 'numIncorrect',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QuestionInstance.numCorrect'
        db.add_column(u'assignment_questioninstance', 'numCorrect',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Question.numCorrect'
        db.delete_column(u'assignment_question', 'numCorrect')

        # Deleting field 'Question.numIncorrect'
        db.delete_column(u'assignment_question', 'numIncorrect')
