...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.isCopy'
        db.add_column(u'assignment_question', 'isCopy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.original'
        db.add_column(u'assignment_question', 'original',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='copy', to=orm['assignment.Question']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.isCopy'
        db.delete_column(u'assignment_question', 'isCopy')

        # Deleting field 'Question.original'
        db.delete_column(u'assignment_question', 'original_id')
