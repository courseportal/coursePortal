...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.original'
        db.alter_column(u'assignment_question', 'original_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['assignment.Question']))

    def backwards(self, orm):

        # Changing field 'Question.original'
        db.alter_column(u'assignment_question', 'original_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assignment.Question']))
