...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variable.view_code'
        db.add_column(u'assignment_variable', 'view_code',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variable.view_code'
        db.delete_column(u'assignment_variable', 'view_code')
    ...
    models = {
        ...
        u'assignment.variable': {
            ...
            'view_code': ('django.db.models.fields.TextField', [], {'default': "''"})
        },
        u'auth.group': {
