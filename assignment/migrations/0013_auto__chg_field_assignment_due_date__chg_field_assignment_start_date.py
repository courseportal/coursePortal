...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'assignment_assignment', 'due_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Assignment.start_date'
        db.alter_column(u'assignment_assignment', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Assignment.due_date'
        db.alter_column(u'assignment_assignment', 'due_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Assignment.start_date'
        db.alter_column(u'assignment_assignment', 'start_date', self.gf('django.db.models.fields.DateField')())
