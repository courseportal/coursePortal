...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssignmentInstance.due_date'
        db.alter_column(u'assignment_assignmentinstance', 'due_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'AssignmentInstance.start_date'
        db.alter_column(u'assignment_assignmentinstance', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'AssignmentInstance.due_date'
        db.alter_column(u'assignment_assignmentinstance', 'due_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'AssignmentInstance.start_date'
        db.alter_column(u'assignment_assignmentinstance', 'start_date', self.gf('django.db.models.fields.DateField')())
