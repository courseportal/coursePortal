...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionInstance.student_answer'
        db.add_column(u'assignment_questioninstance', 'student_answer',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionInstance.student_answer'
        db.delete_column(u'assignment_questioninstance', 'student_answer')
    ...
    models = {
        ...
        u'assignment.questioninstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'solution': ('django.db.models.fields.TextField', [], {}),
            'student_answer': ('django.db.models.fields.TextField', [], {'default': 'None'}),
