...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentInstance.start_date'
        db.add_column(u'assignment_assignmentinstance', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Adding field 'AssignmentInstance.due_date'
        db.add_column(u'assignment_assignmentinstance', 'due_date',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)


        # Changing field 'Assignment.data'
        db.alter_column(u'assignment_assignment', 'data', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'AssignmentInstance.start_date'
        db.delete_column(u'assignment_assignmentinstance', 'start_date')

        # Deleting field 'AssignmentInstance.due_date'
        db.delete_column(u'assignment_assignmentinstance', 'due_date')


        # Changing field 'Assignment.data'
        db.alter_column(u'assignment_assignment', 'data', self.gf('django.db.models.fields.TextField')(default=None))
