...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionInstance.template'
        db.add_column(u'assignment_questioninstance', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='instances', to=orm['assignment.Question']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionInstance.template'
        db.delete_column(u'assignment_questioninstance', 'template_id')
