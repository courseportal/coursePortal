...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'assignment_variable', (
            ...
            ('validation_code', self.gf('django.db.models.fields.TextField')(default='return True')),
            ('generated_code', self.gf('django.db.models.fields.TextField')()),
        ))
    ...
    models = {
        ...
        u'assignment.variable': {
            ...
            'generated_code': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'validation_code': ('django.db.models.fields.TextField', [], {'default': "'return True'"}),
