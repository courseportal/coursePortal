...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assignment_assignment', 'due_date',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Adding field 'Assignment.start_date'
        db.add_column(u'assignment_assignment', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'assignment_assignment', 'due_date')

        # Deleting field 'Assignment.start_date'
        db.delete_column(u'assignment_assignment', 'start_date')
