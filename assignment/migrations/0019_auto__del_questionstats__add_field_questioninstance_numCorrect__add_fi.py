...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'assignment_questionstats')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'assignment_questionstats', (
            ('numCorrect', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats', to=orm['assignment.Question'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('numIncorrect', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'assignment', ['QuestionStats'])
