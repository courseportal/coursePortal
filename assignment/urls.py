...
urlpatterns = patterns('',
    ...
    url(r'question/edit/?$', 'assignment.views.question.editQlist', name='edit_question_list'),
    ...
    url(r'select/?$', 'assignment.views.staff.selectInstance', name='select'),
    ...
    url(r'edit/?$', 'assignment.views.assign.editAlist', name='edit_assignment_list'),
